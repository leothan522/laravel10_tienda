<div class="card card-navy" style="height: inherit; width: inherit; transition: all 0.15s ease 0s;">
    ...
    <div class="card-header">
        <h3 class="card-title">
            @if(/*$new_articulo*/true) Nuevo Articulo @endif
            @if(/* !$new_articulo && $view == 'form' */ true) Editar Articulo @endif
            @if(/* $view != "form" */ true) Ver Articulo @endif
        </h3>
        <div class="card-tools">
            {{--<span class="btn btn-tool"><i class="fas fa-list"></i></span>--}}
            @if(/*$btn_nuevo*/ true) <button class="btn btn-tool" wire:click="create"><i class="fas fa-file"></i> Nuevo</button> @endif
            @if(/*$btn_editar*/ true) <button class="btn btn-tool" wire:click="btnEditar"><i class="fas fa-edit"></i> Editar</button> @endif
            @if(/*$btn_cancelar*/ true) <button class="btn btn-tool" wire:click="btnCancelar"><i class="fas fa-ban"></i> Cancelar</button> @endif
        </div>
    </div>
