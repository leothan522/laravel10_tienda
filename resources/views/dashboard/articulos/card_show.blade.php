<div class="card card-navy" style="height: inherit; width: inherit; transition: all 0.15s ease 0s;" xmlns:wire="http://www.w3.org/1999/xhtml">
    ...
    <div class="card-header">
        ...
        <div class="card-tools">
            ...
            @if($btn_nuevo) <button class="btn btn-tool" wire:click="create" @if(!comprobarPermisos('articulos.create')) disabled @endif ><i class="fas fa-file"></i> Nuevo</button> @endif
            @if($btn_editar) <button class="btn btn-tool" wire:click="btnEditar" @if(!comprobarPermisos('articulos.edit')) disabled @endif ><i class="fas fa-edit"></i> Editar</button> @endif
