    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <div class="row col-md-12">
                    ...
                    <div class="col-md-5 justify-content-end">
                        <form wire:submit.prevent="buscarCategoria">
                            <div class="input-group close">
                                <input type="search" class="form-control" placeholder="Buscar" wire:model.defer="keywordCategorias" required>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        @include('dashboard.articulos.card_form_categorias')
                    </div>
                    <div class="col-md-8">
                        @include('dashboard.articulos.card_table_categorias')
                    </div>
                </div>
