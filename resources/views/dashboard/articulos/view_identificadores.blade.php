<div class="row @if($view == 'identificadores') d-block @else d-none @endif">
                ...
                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="custom-tabs-three-home-tab" data-toggle="pill"
                           ...
                           aria-selected="true">Identificadores</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <div class="tab-content" id="custom-tabs-three-tabContent">
                    <div class="tab-pane fade active show" id="tabs_datos_basicos" role="tabpanel"
                        ...
                        <div class="row table-responsive p-0">
                            <form wire:submit="saveIdentificadores" xmlns:wire="http://www.w3.org/1999/xhtml">
                                <table class="table">
                                    <thead>
                                    <tr class="text-navy">
                                    ...
                                    @if($listarIdentificadores)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <button type="button"
                                                            wire:click="editarIdentificador({{ $artiden->id }})"
                                                    ...
                                                    <button type="button"
                                                            wire:click="borrarIdentificador({{ $artiden->id }})"
                                                            class="btn btn-primary btn-xs"
                                                            @if(!comprobarPermisos('articulos.identificadores')) disabled @endif >
                                    ...
                                    <span>
                                        ...
                                        @endif
                                            ...
                                            <input type="hidden" placeholder="identificadores_id"
                                                   wire:model.live="identificador_id"/>
                                        </th>
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control"
                                                       wire:model="identificador_serial"
                                        ...
                                        <td class="text-right">
                                            <div class="form-group">
                                                <input type="number" class="form-control"
                                                       wire:model="identificador_cantidad" placeholder="Cantidad"
                                                       min="0.001" step=".001">
