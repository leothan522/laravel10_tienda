<div class="row @if($view == 'precios') d-block @else d-none @endif">
                                ...
                                <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <button type="button"
                                                                wire:click="borrarPrecio({{ $precio->id }})"
                                                                class="btn btn-primary btn-xs"
                                                                @if(!comprobarPermisos('articulos.precios')) disabled @endif >
                                    ...
                                    <span>
                                        ...
                                        @endif
                                            ...
                                            <input type="hidden" wire:model.live="precio_id"/>
                                        </th>
                                        <td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <select
                                                    class="custom-select @error('precio_unidad') is-invalid @enderror "
                                                    wire:model="precio_unidad">
                                                    @if($listarPreciosUnd)
                                                        @foreach($listarPreciosUnd as $unidad)
                                                            <option
                                                                value="{{ $unidad['id'] }}">{{ $unidad['codigo'] }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                                {{--@error('precio_unidad')
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <select
                                                    class="custom-select @error('precio_moneda') is-invalid @enderror "
                                                    wire:model="precio_moneda">
                                        ...
                                        <td class="text-right">
                                            <div class="form-group">
                                                <input type="number"
                                                       class="form-control @error('precio_precio') is-invalid @enderror "
                                                       wire:model="precio_precio" placeholder="Precio" min="0.01"
                                                       step=".01">
                                                {{--@error('precio_precio')
                                                <span class="col-sm-12 text-sm text-bold text-danger">
                                                    <i class="icon fas fa-exclamation-triangle"></i>
