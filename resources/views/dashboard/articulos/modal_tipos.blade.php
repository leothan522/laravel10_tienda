    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <div class="row col-md-12">
                    ...
                    <div class="col-md-5 justify-content-end">
                        <form wire:submit.prevent="buscarTipos">
                            <div class="input-group close">
                                <input type="search" class="form-control" placeholder="Buscar" wire:model.defer="keywordTipos" required>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        @include('dashboard.articulos.card_form_tipos')
                    </div>
                    <div class="col-md-8">
                        @include('dashboard.articulos.card_table_tipos')
                    </div>
                </div>
